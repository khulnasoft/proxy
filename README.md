...
The following table shows the Khulnasoft proxy version compatibility with supported upstream Khulnasoft versions.
...
This image can then be used in the [Envoy DaemonSet mode](https://docs.khulnasoft.io/en/stable/security/network/proxy/envoy/#enable-and-configure-envoy-daemonset).
