...
// 	protoc        v5.26.1
// source: khulnasoft/api/websocket.proto
...
func (x *WebSocketClient) Reset() {
	*x = WebSocketClient{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_api_websocket_proto_msgTypes[0]
...
func (*WebSocketClient) Descriptor() ([]byte, []int) {
	return file_khulnasoft_api_websocket_proto_rawDescGZIP(), []int{0}
}
...
func (x *WebSocketServer) Reset() {
	*x = WebSocketServer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_api_websocket_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*WebSocketServer) Descriptor() ([]byte, []int) {
	return file_khulnasoft_api_websocket_proto_rawDescGZIP(), []int{1}
}
...
var File_khulnasoft_api_websocket_proto protoreflect.FileDescriptor

var file_khulnasoft_api_websocket_proto_rawDesc = []byte{
...
var (
	file_khulnasoft_api_websocket_proto_rawDescOnce sync.Once
	file_khulnasoft_api_websocket_proto_rawDescData = file_khulnasoft_api_websocket_proto_rawDesc
)

func file_khulnasoft_api_websocket_proto_rawDescGZIP() []byte {
	file_khulnasoft_api_websocket_proto_rawDescOnce.Do(func() {
		file_khulnasoft_api_websocket_proto_rawDescData = protoimpl.X.CompressGZIP(file_khulnasoft_api_websocket_proto_rawDescData)
	})
	return file_khulnasoft_api_websocket_proto_rawDescData
}

var file_khulnasoft_api_websocket_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_khulnasoft_api_websocket_proto_goTypes = []interface{}{
	(*WebSocketClient)(nil),     // 0: khulnasoft.WebSocketClient
	(*WebSocketServer)(nil),     // 1: khulnasoft.WebSocketServer
	(*durationpb.Duration)(nil), // 2: google.protobuf.Duration
}
var file_khulnasoft_api_websocket_proto_depIdxs = []int32{
	2, // 0: khulnasoft.WebSocketClient.handshake_timeout:type_name -> google.protobuf.Duration
	2, // 1: khulnasoft.WebSocketClient.ping_interval:type_name -> google.protobuf.Duration
	2, // 2: khulnasoft.WebSocketServer.handshake_timeout:type_name -> google.protobuf.Duration
	2, // 3: khulnasoft.WebSocketServer.ping_interval:type_name -> google.protobuf.Duration
...
func init() { file_khulnasoft_api_websocket_proto_init() }
func file_khulnasoft_api_websocket_proto_init() {
	if File_khulnasoft_api_websocket_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_khulnasoft_api_websocket_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_khulnasoft_api_websocket_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_khulnasoft_api_websocket_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_khulnasoft_api_websocket_proto_goTypes,
		DependencyIndexes: file_khulnasoft_api_websocket_proto_depIdxs,
		MessageInfos:      file_khulnasoft_api_websocket_proto_msgTypes,
	}.Build()
	File_khulnasoft_api_websocket_proto = out.File
	file_khulnasoft_api_websocket_proto_rawDesc = nil
	file_khulnasoft_api_websocket_proto_goTypes = nil
	file_khulnasoft_api_websocket_proto_depIdxs = nil
}
