...
// 	protoc        v5.26.1
// source: khulnasoft/api/accesslog.proto
...
func (HttpProtocol) Descriptor() protoreflect.EnumDescriptor {
	return file_khulnasoft_api_accesslog_proto_enumTypes[0].Descriptor()
}

func (HttpProtocol) Type() protoreflect.EnumType {
	return &file_khulnasoft_api_accesslog_proto_enumTypes[0]
}
...
func (HttpProtocol) EnumDescriptor() ([]byte, []int) {
	return file_khulnasoft_api_accesslog_proto_rawDescGZIP(), []int{0}
}
...
func (EntryType) Descriptor() protoreflect.EnumDescriptor {
	return file_khulnasoft_api_accesslog_proto_enumTypes[1].Descriptor()
}

func (EntryType) Type() protoreflect.EnumType {
	return &file_khulnasoft_api_accesslog_proto_enumTypes[1]
}
...
func (EntryType) EnumDescriptor() ([]byte, []int) {
	return file_khulnasoft_api_accesslog_proto_rawDescGZIP(), []int{1}
}
...
func (x *KeyValue) Reset() {
	*x = KeyValue{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_api_accesslog_proto_msgTypes[0]
...
type HttpLogEntry struct {
	...
	HttpProtocol HttpProtocol `protobuf:"varint,1,opt,name=http_protocol,json=httpProtocol,proto3,enum=khulnasoft.HttpProtocol" json:"http_protocol,omitempty"`
...
func (x *HttpLogEntry) Reset() {
	*x = HttpLogEntry{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_api_accesslog_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *KafkaLogEntry) Reset() {
	*x = KafkaLogEntry{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_api_accesslog_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*KafkaLogEntry) Descriptor() ([]byte, []int) {
	return file_khulnasoft_api_accesslog_proto_rawDescGZIP(), []int{2}
}
...
func (x *L7LogEntry) Reset() {
	*x = L7LogEntry{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_api_accesslog_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*L7LogEntry) Descriptor() ([]byte, []int) {
	return file_khulnasoft_api_accesslog_proto_rawDescGZIP(), []int{3}
}
...
type LogEntry struct {
	...
	EntryType EntryType `protobuf:"varint,3,opt,name=entry_type,json=entryType,proto3,enum=khulnasoft.EntryType" json:"entry_type,omitempty"`
	...
	KhulnasoftRuleRef string `protobuf:"bytes,5,opt,name=khulnasoft_rule_ref,json=khulnasoftRuleRef,proto3" json:"khulnasoft_rule_ref,omitempty"`
...
func (x *LogEntry) Reset() {
	*x = LogEntry{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_api_accesslog_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LogEntry) Descriptor() ([]byte, []int) {
	return file_khulnasoft_api_accesslog_proto_rawDescGZIP(), []int{4}
}
...
func (x *LogEntry) GetKhulnasoftRuleRef() string {
	if x != nil {
		return x.KhulnasoftRuleRef
	}
	return ""
}
...
var File_khulnasoft_api_accesslog_proto protoreflect.FileDescriptor

var file_khulnasoft_api_accesslog_proto_rawDesc = []byte{
...
var (
	file_khulnasoft_api_accesslog_proto_rawDescOnce sync.Once
	file_khulnasoft_api_accesslog_proto_rawDescData = file_khulnasoft_api_accesslog_proto_rawDesc
)

func file_khulnasoft_api_accesslog_proto_rawDescGZIP() []byte {
	file_khulnasoft_api_accesslog_proto_rawDescOnce.Do(func() {
		file_khulnasoft_api_accesslog_proto_rawDescData = protoimpl.X.CompressGZIP(file_khulnasoft_api_accesslog_proto_rawDescData)
	})
	return file_khulnasoft_api_accesslog_proto_rawDescData
}

var file_khulnasoft_api_accesslog_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_khulnasoft_api_accesslog_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_khulnasoft_api_accesslog_proto_goTypes = []interface{}{
	(HttpProtocol)(0),     // 0: khulnasoft.HttpProtocol
	(EntryType)(0),        // 1: khulnasoft.EntryType
	(*KeyValue)(nil),      // 2: khulnasoft.KeyValue
	(*HttpLogEntry)(nil),  // 3: khulnasoft.HttpLogEntry
	(*KafkaLogEntry)(nil), // 4: khulnasoft.KafkaLogEntry
	(*L7LogEntry)(nil),    // 5: khulnasoft.L7LogEntry
	(*LogEntry)(nil),      // 6: khulnasoft.LogEntry
	nil,                   // 7: khulnasoft.L7LogEntry.FieldsEntry
}
var file_khulnasoft_api_accesslog_proto_depIdxs = []int32{
	0, // 0: khulnasoft.HttpLogEntry.http_protocol:type_name -> khulnasoft.HttpProtocol
	2, // 1: khulnasoft.HttpLogEntry.headers:type_name -> khulnasoft.KeyValue
	2, // 2: khulnasoft.HttpLogEntry.missing_headers:type_name -> khulnasoft.KeyValue
	2, // 3: khulnasoft.HttpLogEntry.rejected_headers:type_name -> khulnasoft.KeyValue
	7, // 4: khulnasoft.L7LogEntry.fields:type_name -> khulnasoft.L7LogEntry.FieldsEntry
	1, // 5: khulnasoft.LogEntry.entry_type:type_name -> khulnasoft.EntryType
	3, // 6: khulnasoft.LogEntry.http:type_name -> khulnasoft.HttpLogEntry
	4, // 7: khulnasoft.LogEntry.kafka:type_name -> khulnasoft.KafkaLogEntry
	5, // 8: khulnasoft.LogEntry.generic_l7:type_name -> khulnasoft.L7LogEntry
...
func init() { file_khulnasoft_api_accesslog_proto_init() }
func file_khulnasoft_api_accesslog_proto_init() {
	if File_khulnasoft_api_accesslog_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_khulnasoft_api_accesslog_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_khulnasoft_api_accesslog_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_khulnasoft_api_accesslog_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_khulnasoft_api_accesslog_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_khulnasoft_api_accesslog_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	file_khulnasoft_api_accesslog_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*LogEntry_Http)(nil),
		(*LogEntry_Kafka)(nil),
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_khulnasoft_api_accesslog_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_khulnasoft_api_accesslog_proto_goTypes,
		DependencyIndexes: file_khulnasoft_api_accesslog_proto_depIdxs,
		EnumInfos:         file_khulnasoft_api_accesslog_proto_enumTypes,
		MessageInfos:      file_khulnasoft_api_accesslog_proto_msgTypes,
	}.Build()
	File_khulnasoft_api_accesslog_proto = out.File
	file_khulnasoft_api_accesslog_proto_rawDesc = nil
	file_khulnasoft_api_accesslog_proto_goTypes = nil
	file_khulnasoft_api_accesslog_proto_depIdxs = nil
}
