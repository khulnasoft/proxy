...
// 	protoc        v5.26.1
// source: khulnasoft/api/nphds.proto
...
import (
	...
	v3 "github.com/khulnasoft/proxy/go/envoy/service/discovery/v3"
...
func (x *NetworkPolicyHosts) Reset() {
	*x = NetworkPolicyHosts{}
	if protoimpl.UnsafeEnabled {
		mi := &file_khulnasoft_api_nphds_proto_msgTypes[0]
...
func (*NetworkPolicyHosts) Descriptor() ([]byte, []int) {
	return file_khulnasoft_api_nphds_proto_rawDescGZIP(), []int{0}
}
...
var File_khulnasoft_api_nphds_proto protoreflect.FileDescriptor

var file_khulnasoft_api_nphds_proto_rawDesc = []byte{
...
var (
	file_khulnasoft_api_nphds_proto_rawDescOnce sync.Once
	file_khulnasoft_api_nphds_proto_rawDescData = file_khulnasoft_api_nphds_proto_rawDesc
)

func file_khulnasoft_api_nphds_proto_rawDescGZIP() []byte {
	file_khulnasoft_api_nphds_proto_rawDescOnce.Do(func() {
		file_khulnasoft_api_nphds_proto_rawDescData = protoimpl.X.CompressGZIP(file_khulnasoft_api_nphds_proto_rawDescData)
	})
	return file_khulnasoft_api_nphds_proto_rawDescData
}

var file_khulnasoft_api_nphds_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_khulnasoft_api_nphds_proto_goTypes = []interface{}{
	(*NetworkPolicyHosts)(nil),   // 0: khulnasoft.NetworkPolicyHosts
...
var file_khulnasoft_api_nphds_proto_depIdxs = []int32{
	1, // 0: khulnasoft.NetworkPolicyHostsDiscoveryService.StreamNetworkPolicyHosts:input_type -> envoy.service.discovery.v3.DiscoveryRequest
	1, // 1: khulnasoft.NetworkPolicyHostsDiscoveryService.FetchNetworkPolicyHosts:input_type -> envoy.service.discovery.v3.DiscoveryRequest
	2, // 2: khulnasoft.NetworkPolicyHostsDiscoveryService.StreamNetworkPolicyHosts:output_type -> envoy.service.discovery.v3.DiscoveryResponse
	2, // 3: khulnasoft.NetworkPolicyHostsDiscoveryService.FetchNetworkPolicyHosts:output_type -> envoy.service.discovery.v3.DiscoveryResponse
...
func init() { file_khulnasoft_api_nphds_proto_init() }
func file_khulnasoft_api_nphds_proto_init() {
	if File_khulnasoft_api_nphds_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_khulnasoft_api_nphds_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_khulnasoft_api_nphds_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_khulnasoft_api_nphds_proto_goTypes,
		DependencyIndexes: file_khulnasoft_api_nphds_proto_depIdxs,
		MessageInfos:      file_khulnasoft_api_nphds_proto_msgTypes,
	}.Build()
	File_khulnasoft_api_nphds_proto = out.File
	file_khulnasoft_api_nphds_proto_rawDesc = nil
	file_khulnasoft_api_nphds_proto_goTypes = nil
	file_khulnasoft_api_nphds_proto_depIdxs = nil
}
...
func (c *networkPolicyHostsDiscoveryServiceClient) StreamNetworkPolicyHosts(ctx context.Context, opts ...grpc.CallOption) (NetworkPolicyHostsDiscoveryService_StreamNetworkPolicyHostsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_NetworkPolicyHostsDiscoveryService_serviceDesc.Streams[0], "/khulnasoft.NetworkPolicyHostsDiscoveryService/StreamNetworkPolicyHosts", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *networkPolicyHostsDiscoveryServiceClient) FetchNetworkPolicyHosts(ctx context.Context, in *v3.DiscoveryRequest, opts ...grpc.CallOption) (*v3.DiscoveryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/khulnasoft.NetworkPolicyHostsDiscoveryService/FetchNetworkPolicyHosts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _NetworkPolicyHostsDiscoveryService_FetchNetworkPolicyHosts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/khulnasoft.NetworkPolicyHostsDiscoveryService/FetchNetworkPolicyHosts",
	}
...
var _NetworkPolicyHostsDiscoveryService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "khulnasoft.NetworkPolicyHostsDiscoveryService",
	...
	Metadata: "khulnasoft/api/nphds.proto",
}
