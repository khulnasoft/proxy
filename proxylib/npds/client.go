...
import (
	...
	envoy_config_core "github.com/khulnasoft/proxy/go/envoy/config/core/v3"
	envoy_service_discovery "github.com/khulnasoft/proxy/go/envoy/service/discovery/v3"
...
const (
	...
	NPDSTypeURL  = "type.googleapis.com/khulnasoft.NetworkPolicy"
)
...
func (c *Client) Run(connected func()) (err error) {
	...
	client := khulnasoft.NewNetworkPolicyDiscoveryServiceClient(conn)
