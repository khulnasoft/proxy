...
import (
	...
	core "github.com/khulnasoft/proxy/go/envoy/config/core/v3"
)
...
type L7RuleParser func(rule *khulnasoft.PortNetworkPolicyRule) []L7NetworkPolicyRule
...
func newPortNetworkPolicyRule(config *khulnasoft.PortNetworkPolicyRule) (PortNetworkPolicyRule, string, bool) {
	...
	// TODO: Remove when Khulnasoft 1.14 is no longer supported:
...
func newPortNetworkPolicyRules(config []*khulnasoft.PortNetworkPolicyRule, port uint32) (PortNetworkPolicyRules, bool) {
...
func newPortNetworkPolicies(config []*khulnasoft.PortNetworkPolicy, dir string) PortNetworkPolicies {
...
func (p *PortNetworkPolicies) Matches(port, remoteId uint32, l7 interface{}) bool {
	...
	// No policy for the port was found. Khulnasoft always creates a policy for redirects it
...
type PolicyInstance struct {
	protobuf *khulnasoft.NetworkPolicy
	Ingress  PortNetworkPolicies
	Egress   PortNetworkPolicies
}

func newPolicyInstance(config *khulnasoft.NetworkPolicy) *PolicyInstance {
