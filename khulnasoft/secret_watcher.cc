...
envoy::config::core::v3::ConfigSource getKhulnasoftSDSConfig(const std::string&) {
  /* returned config_source has initial_fetch_timeout of 50 milliseconds. */
  return Khulnasoft::khulnasoft_xds_api_config;
}
...
getSDSConfigFunc getSDSConfig = &getKhulnasoftSDSConfig;
void setSDSConfigFunc(getSDSConfigFunc func) { getSDSConfig = func; }
void resetSDSConfigFunc() { getSDSConfig = &getKhulnasoftSDSConfig; }
...
void setCommonConfig(const khulnasoft::TLSContext config,
...
DownstreamTLSContext::DownstreamTLSContext(const NetworkPolicyMap& parent,
                                           const khulnasoft::TLSContext config)
...
UpstreamTLSContext::UpstreamTLSContext(const NetworkPolicyMap& parent, khulnasoft::TLSContext config)
