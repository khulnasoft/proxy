...
#include "khulnasoft/api/health_check_sink.pb.h"
#include "khulnasoft/api/health_check_sink.pb.validate.h" // IWYU pragma: keep
...
protected:
  ...
  explicit HealthCheckEventPipeSink(const khulnasoft::HealthCheckEventPipeSink& config,
...
public:
  ...
  std::string name() const override { return "khulnasoft.health_check.event_sink.pipe"; }

  ProtobufTypes::MessagePtr createEmptyConfigProto() override {
    return ProtobufTypes::MessagePtr{new khulnasoft::HealthCheckEventPipeSink()};
  }
};
