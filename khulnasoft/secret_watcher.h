...
public:
  DownstreamTLSContext(const NetworkPolicyMap& parent, const khulnasoft::TLSContext config);
...
public:
  UpstreamTLSContext(const NetworkPolicyMap& parent, khulnasoft::TLSContext config);
