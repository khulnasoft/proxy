...
public:
  Config(Server::Configuration::FactoryContext& context, bool client,
         ...
         bool ping_when_idle);
  Config(const ::khulnasoft::WebSocketClient& config, Server::Configuration::FactoryContext& context);
  Config(const ::khulnasoft::WebSocketServer& config, Server::Configuration::FactoryContext& context);
