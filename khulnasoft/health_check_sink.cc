#include "khulnasoft/health_check_sink.h"
...
HealthCheckEventPipeSink::HealthCheckEventPipeSink(const khulnasoft::HealthCheckEventPipeSink& config,
...
Upstream::HealthCheckEventSinkPtr HealthCheckEventPipeSinkFactory::createHealthCheckEventSink(
  ...
  const auto& validator_config =
      Envoy::MessageUtil::anyConvertAndValidate<khulnasoft::HealthCheckEventPipeSink>(
