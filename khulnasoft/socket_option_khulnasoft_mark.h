...
// The mark contains the Khulnasoft magic mark, cluster and security identity.
// It uses the Khulnasoft Privileged Service to call out to the starter process to do the actual
// privileged syscall - as the Envoy process itself doesn't have the required capabilities.
class KhulnasoftMarkSocketOption : public Network::Socket::Option,
                               public Logger::Loggable<Logger::Id::filter> {
public:
  KhulnasoftMarkSocketOption(uint32_t mark);
