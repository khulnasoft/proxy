...
KhulnasoftTcpIntegrationTest::KhulnasoftTcpIntegrationTest(const std::string& config)
...
std::string KhulnasoftTcpIntegrationTest::testPolicyFmt() {
  return TestEnvironment::substitute(TCP_POLICY_fmt, GetParam());
}

void KhulnasoftTcpIntegrationTest::createEnvoy() {
...
void KhulnasoftTcpIntegrationTest::initialize() {
