...
class KhulnasoftHttpIntegrationTest : public HttpIntegrationTest,
                                  public testing::TestWithParam<Network::Address::IpVersion> {
public:
  KhulnasoftHttpIntegrationTest(const std::string& config);
  ~KhulnasoftHttpIntegrationTest();
  ...
  waitForAccessLogMessage(::khulnasoft::EntryType entry_type,
  ...
  getHeader(const Protobuf::RepeatedPtrField<::khulnasoft::KeyValue>& headers,
  ...
  static bool hasHeader(const Protobuf::RepeatedPtrField<::khulnasoft::KeyValue>& headers,
