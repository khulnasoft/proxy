...
#include "tests/khulnasoft_http_integration.h"
...
const std::string khulnasoft_proxy_config_fmt = R"EOF(
admin:
  address:
    socket_address:
      address: 127.0.0.1
    ...
    filter_chains:
      ...
      - name: envoy.http_connection_manager
        typed_config:
          ...
          - name: test_l7policy
            typed_config:
              "@type": type.googleapis.com/khulnasoft.L7Policy
...
class KhulnasoftIntegrationTest : public KhulnasoftHttpIntegrationTest {
public:
  KhulnasoftIntegrationTest()
      : KhulnasoftHttpIntegrationTest(fmt::format(
            fmt::runtime(TestEnvironment::substitute(khulnasoft_proxy_config_fmt, GetParam())),
            "true")) {}
  KhulnasoftIntegrationTest(const std::string& config) : KhulnasoftHttpIntegrationTest(config) {}
  ...
  void Denied(Http::TestRequestHeaderMapImpl&& headers) {
    ...
    EXPECT_TRUE(expectAccessLogDeniedTo([&maybe_x_request_id](const ::khulnasoft::LogEntry& entry) {
    ...
    EXPECT_TRUE(
        expectAccessLogResponseTo([&maybe_x_request_id_resp](const ::khulnasoft::LogEntry& entry) {
  ...
  void Accepted(Http::TestRequestHeaderMapImpl&& headers) {
    ...
    // Validate that request access log message with x-request-id is logged
    absl::optional<std::string> maybe_x_request_id;
    EXPECT_TRUE(expectAccessLogRequestTo([&maybe_x_request_id](const ::khulnasoft::LogEntry& entry) {
      maybe_x_request_id = getHeader(entry.http().headers(), "x-request-id");
      return entry.http().status() == 0;
    }));
    ASSERT_TRUE(maybe_x_request_id.has_value());
...
INSTANTIATE_TEST_SUITE_P(IpVersions, KhulnasoftIntegrationTest,
                         testing::ValuesIn(TestEnvironment::getIpVersionsForTest()));

class HostMapTest : public KhulnasoftHttpIntegrationTest {
public:
  HostMapTest()
      : KhulnasoftHttpIntegrationTest(fmt::format(
            fmt::runtime(TestEnvironment::substitute(khulnasoft_proxy_config_fmt, GetParam())),
  ...
  void InvalidHostMap(const std::string& config, const char* exmsg) {
    ...
    Khulnasoft::PolicyHostDecoder host_decoder;

    MessageUtil::loadFromFile(path, message, ProtobufMessage::getNullValidationVisitor(),
                              *api_.get());
    Envoy::Khulnasoft::PolicyHostMap hmap(tls);
...
resources:
- "@type": type.googleapis.com/khulnasoft.NetworkPolicyHosts
  policy: 173
...
- "@type": type.googleapis.com/khulnasoft.NetworkPolicyHosts
  ...
  MessageUtil::loadFromFile(path, message, ProtobufMessage::getNullValidationVisitor(),
                            *api_.get());
  auto hmap = std::make_shared<Envoy::Khulnasoft::PolicyHostMap>(tls);
  const auto decoded_resources = Envoy::Config::DecodedResourcesWrapper(
      host_decoder, message.resources(), message.version_info());
...
TEST_P(KhulnasoftIntegrationTest, AllowedPathPrefix) {
  ...
  // Validate that missing headers are access logged correctly
  EXPECT_TRUE(expectAccessLogRequestTo([](const ::khulnasoft::LogEntry& entry) {
    const auto& http = entry.http();
...
TEST_P(KhulnasoftIntegrationTest, AllowedPathPrefixWrongHeader) {
  Accepted({{":method", "GET"},
            {":path", "/allowed"},
            {":authority", "host"},
...
TEST_P(KhulnasoftIntegrationTest, MultipleRequests) {
  // 1st request
  Accepted({{":method", "GET"},
            {":path", "/allowed"},
            {":authority", "host"},
...
TEST_P(KhulnasoftIntegrationTest, AllowedPathRegex) {
...
TEST_P(KhulnasoftIntegrationTest, AllowedPathRegexDeleteHeader) {
  Accepted({{":method", "GET"},
            {":path", "/maybe/public"},
            {":authority", "host"},
            {"User-Agent", "test"}});
...
TEST_P(KhulnasoftIntegrationTest, AllowedHostRegexDeleteHeader) {
  Accepted({{":method", "GET"},
            {":path", "/maybe/private"},
...
TEST_P(KhulnasoftIntegrationTest, DeniedPath) {
...
TEST_P(KhulnasoftIntegrationTest, AllowedHostString) {
...
TEST_P(KhulnasoftIntegrationTest, AllowedReplaced) {
...
TEST_P(KhulnasoftIntegrationTest, Denied42) {
  Denied({{":method", "GET"},
          {":path", "/allowed"},
          {":authority", "host"},
          {"header42", "anything"}});
...
TEST_P(KhulnasoftIntegrationTest, AllowedReplacedAndDeleted) {
  Accepted({{":method", "GET"},
            {":path", "/allowed"},
...
TEST_P(KhulnasoftIntegrationTest, AllowedHostRegex) {
...
TEST_P(KhulnasoftIntegrationTest, DeniedMethod) {
...
TEST_P(KhulnasoftIntegrationTest, AcceptedMethod) {
...
TEST_P(KhulnasoftIntegrationTest, L3DeniedPath) {
...
class KhulnasoftIntegrationPortTest : public KhulnasoftIntegrationTest {
public:
  KhulnasoftIntegrationPortTest() : KhulnasoftIntegrationTest() {}
...
INSTANTIATE_TEST_SUITE_P(IpVersions, KhulnasoftIntegrationPortTest,
                         testing::ValuesIn(TestEnvironment::getIpVersionsForTest()));

TEST_P(KhulnasoftIntegrationPortTest, DuplicatePortAllowedPath) {
  Accepted({{":method", "GET"}, {":path", "/only-2-allowed"}, {":authority", "host"}});
}

TEST_P(KhulnasoftIntegrationPortTest, DuplicatePortAllowedPath2) {
  Accepted({{":method", "GET"}, {":path", "/also-2-allowed"}, {":authority", "host"}});
}

class KhulnasoftIntegrationPortRangeTest : public KhulnasoftIntegrationTest {
public:
  KhulnasoftIntegrationPortRangeTest() : KhulnasoftIntegrationTest() {}
...
INSTANTIATE_TEST_SUITE_P(IpVersions, KhulnasoftIntegrationPortRangeTest,
                         testing::ValuesIn(TestEnvironment::getIpVersionsForTest()));

TEST_P(KhulnasoftIntegrationPortRangeTest, InvalidRange) {
  initialize();
...
class KhulnasoftIntegrationEgressTest : public KhulnasoftIntegrationTest {
public:
  KhulnasoftIntegrationEgressTest()
      : KhulnasoftIntegrationTest(fmt::format(
            fmt::runtime(TestEnvironment::substitute(khulnasoft_proxy_config_fmt, GetParam())),
            "false")) {
...
INSTANTIATE_TEST_SUITE_P(IpVersions, KhulnasoftIntegrationEgressTest,
                         testing::ValuesIn(TestEnvironment::getIpVersionsForTest()));

TEST_P(KhulnasoftIntegrationEgressTest, DeniedPathPrefix) {
  Denied({{":method", "GET"}, {":path", "/prefix"}, {":authority", "host"}});
}

TEST_P(KhulnasoftIntegrationEgressTest, AllowedPathPrefix) {
  Accepted({{":method", "GET"}, {":path", "/allowed"}, {":authority", "host"}});
}

TEST_P(KhulnasoftIntegrationEgressTest, AllowedPathRegex) {
  Accepted({{":method", "GET"}, {":path", "/maybe/public"}, {":authority", "host"}});
}

TEST_P(KhulnasoftIntegrationEgressTest, DeniedPath) {
  Denied({{":method", "GET"}, {":path", "/maybe/private"}, {":authority", "host"}});
}

TEST_P(KhulnasoftIntegrationEgressTest, AllowedHostString) {
  Accepted({{":method", "GET"}, {":path", "/maybe/private"}, {":authority", "allowedHOST"}});
}

TEST_P(KhulnasoftIntegrationEgressTest, AllowedHostRegex) {
  Accepted({{":method", "GET"}, {":path", "/maybe/private"}, {":authority", "hostREGEXname"}});
}

TEST_P(KhulnasoftIntegrationEgressTest, DeniedMethod) {
  Denied({{":method", "POST"}, {":path", "/maybe/private"}, {":authority", "host"}});
}

TEST_P(KhulnasoftIntegrationEgressTest, AcceptedMethod) {
  Accepted({{":method", "PUT"}, {":path", "/public/opinions"}, {":authority", "host"}});
}

TEST_P(KhulnasoftIntegrationEgressTest, L3DeniedPath) {
  Denied({{":method", "GET"}, {":path", "/only-2-allowed"}, {":authority", "host"}});
}
...
class KhulnasoftIntegrationEgressL34Test : public KhulnasoftIntegrationEgressTest {
public:
  KhulnasoftIntegrationEgressL34Test() {}

  std::string testPolicyFmt() { return TestEnvironment::substitute(L34_POLICY_fmt, GetParam()); }
};

INSTANTIATE_TEST_SUITE_P(IpVersions, KhulnasoftIntegrationEgressL34Test,
                         testing::ValuesIn(TestEnvironment::getIpVersionsForTest()));

TEST_P(KhulnasoftIntegrationEgressL34Test, DeniedPathPrefix) {
  Denied({{":method", "GET"}, {":path", "/prefix"}, {":authority", "host"}});
}

TEST_P(KhulnasoftIntegrationEgressL34Test, DeniedPathPrefix2) {
...
class SDSIntegrationTest : public KhulnasoftIntegrationTest {
public:
  SDSIntegrationTest() : KhulnasoftIntegrationTest() {
...
TEST_P(SDSIntegrationTest, TestMissingSDSSecretOnUpdate) {
  ...
  ENVOY_LOG_MISC(debug,
                 "Updating Khulnasoft Network Policy from file \'{}\'->\'{}\' instead "
                 "of using gRPC",
