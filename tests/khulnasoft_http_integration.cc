...
KhulnasoftHttpIntegrationTest::KhulnasoftHttpIntegrationTest(const std::string& config)
...
KhulnasoftHttpIntegrationTest::~KhulnasoftHttpIntegrationTest() {}

void KhulnasoftHttpIntegrationTest::createEnvoy() {
  ...
  // Pass the fake upstream address to the khulnasoft bpf filter that will set it as
