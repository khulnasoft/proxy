...
class KhulnasoftTest : public testing::Test {
protected:
  Event::SimulatedTimeSystem time_system_;
};

TEST_F(KhulnasoftTest, AccessLog) {
  ...
  EXPECT_EQ(log.entry_.entry_type(), ::khulnasoft::EntryType::Request);
  ...
  EXPECT_EQ(::khulnasoft::HttpProtocol::HTTP11, log.entry_.http().http_protocol());
